...
namespace D2L.Extensibility.AuthSdk.UnitTests {
	internal static class TestConstants {
		public const string APP_ID = "foo";
		public const string APP_KEY = "asdfghjkasdfghjk";
		public const string SCHEME = "https";
		public const string HOST_NAME = "authenticationhost.com";
		public const int PORT = 44444;
		public const string USER_ID = "42";
		public const string USER_KEY = "qwertyuiopqwertyuiop";
